...
export default function HeroSection({ name, title, bio }: HeroSectionProps) {
  ...
  const roles = [
    { title: "Full Stack Developer", icon: Code2, description: "Building end-to-end solutions" },
    { title: "UI/UX Architect", icon: Layers, description: "Creating seamless experiences" },
    { title: "Tech Lead", icon: Globe, description: "Leading innovation teams" },
    { title: "Problem Solver", icon: Cpu, description: "Solving complex challenges" },
  ];
  ...
  const testimonials = [
    { text: "One of the most talented developers I've worked with", author: "Tech Lead, Google", rating: 5 },
    { text: "Exceptional problem-solving skills and clean code", author: "CTO, Startup", rating: 5 },
    { text: "Delivered complex features ahead of schedule", author: "Product Manager", rating: 5 },
  ];
  ...
  const socials = [
    { Icon: Github, href: "https://github.com/rashedulraha", label: "GitHub", color: "hover:text-[#333]" },
    { Icon: Linkedin, href: "https://www.linkedin.com/in/rashedulraha/", label: "LinkedIn", color: "hover:text-[#0077b5]" },
    { Icon: Twitter, href: "https://x.com/rashedulraha", label: "Twitter", color: "hover:text-[#1DA1F2]" },
    { Icon: Mail, href: "mailto:rashedulraha.bd@gmail.com", label: "Email", color: "hover:text-[#EA4335]" },
  ];

  const scrollToNext = () => {
    const nextSection =
      document.getElementById("tech-stack") || document.querySelector("section:not(.hero)");
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <FloatingShape delay={0} duration={25} className="top-20 right-20 w-32 h-32 border border-primary/20 rounded-full" />
        <FloatingShape delay={2} duration={20} className="bottom-32 left-20 w-24 h-24 border border-secondary/20 rounded-2xl" />
        <FloatingShape delay={1} duration={30} className="top-1/3 left-1/4 w-16 h-16 border border-accent/20 rounded-lg" />
      </div>
              ...
              <div className="text-center lg:text-left">
                ...
                >
                  ...
                  <MagneticButton>
                    ...
                    >
                      <Link href="/projects" onClick={scrollToNext} className="flex items-center gap-2">
              ...
              >
                ...
                <div className="bg-gradient-to-r from-primary/5 via-secondary/5 to-primary/5 rounded-2xl p-6 border border-primary/20 shadow-lg">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-foreground">What people say</h3>
                  </div>
                  <AnimatePresence mode="wait">
                    <motion.div
                    ...
                    {testimonials.map((_, idx) => (
                      <button
                        ...
                        className={`h-2 rounded-full transition-all duration-300 ${
                          activeTestimonial === idx ? "w-6 bg-primary" : "w-2 bg-muted-foreground/30"
                        }`}
                      />
                    ))}
                  </div>
